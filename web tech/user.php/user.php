  ...
  <div class="container-fluid bg-warning">
    ...
    <div class="container">
        <div class="row my-3 justify-content-between">
            ...
            <div class="col-3">
                <button type="button" class="btn btn-success"><a href="https://cmrtc.ac.in/academics/courses-offered/" class="text-light">Courses</a></button>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active fs-6 fw-bold anchor" aria-current="page" href="https://cmrtc.ac.in/">HOME</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold anchor" href="https://cmrtc.ac.in/administration/about-college/">ADMINISTRATION</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold anchor" href="https://cmrtc.ac.in/administration/about-college/#">ACADEMICS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold anchor" href="https://cmrtc.ac.in/administration/about-college/#">INFARSTRUCTURE</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold anchor" href="https://cmrtc.ac.in/t-p-cell/about-t-p-cell/">PLACEMENTS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold anchor" href="https://cmrtc.ac.in/t-p-cell/about-t-p-cell/#">DEPARTMENTS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold anchor" href="https://cmrtc.ac.in/vtour-child/research/">RESEARCH</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold" href="https://cmrtc.ac.in/vtour-child/amenities/">AMENITIES</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold anchor" href="https://cmrtc.ac.in/exam-section/schedules/">EXAM SECTION</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light fs-6 fw-bold anchor" href="https://cmrtc.ac.in/contact/">CONTACT</a>
              </li>
            </ul>
